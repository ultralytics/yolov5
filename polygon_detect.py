...
from utils.datasets_polygon import LoadStreams, LoadImages
from utils.general_polygon import check_img_size, check_requirements, check_imshow, non_max_suppression, apply_classifier, \
    scale_coords, xyxy2xywh, strip_optimizer, set_logging, increment_path, save_one_box, \
    polygon_non_max_suppression, polygon_scale_coords
from utils.plots_polygon import colors, plot_one_box, polygon_plot_one_box
...
def detect(weights='polygon-yolov5s-ucas.pt',  # model.pt path(s)
    ...
    t0 = time.time()
    for path, img, im0s, vid_cap, __ in dataset:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=r"C:\Users\ATA\Downloads\polygon_best (1).pt", help='model.pt path(s)')
    parser.add_argument('--source', type=str, default=r'D:\VS\YOLO_V5_PROJECTS\PolygonObjectDetection\board_images', help='file/dir/URL/glob, 0 for webcam')
