...
# DEPRECATED {
, withJava ? config.steam.java (true or false)
, withPrimus ? config.steam.primus (true or false)
}: 
...
  ldPath = lib.optionals stdenv.is84bit [ "/lib64" ]
  ++ [ "/lib32" ]
  ++    (x: "/steamrt/${steam-runtime-wrapped.arch}/" + x) steam-runtime-wrapped.libs
