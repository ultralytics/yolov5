from models.yolo import Detect, DetectRAYOLO
...
def set_model_grad_status(img, model_instance, heights=[810, 1620]):
    ...
    print(f"Trainable params: {trainable_params_count}/{total_params_count} ({trainable_params_count/total_params_count:.1%})")
    LOGGER.info(f"Trainable params: {trainable_params_count}/{total_params_count} ({trainable_params_count/total_params_count:.1%})")
