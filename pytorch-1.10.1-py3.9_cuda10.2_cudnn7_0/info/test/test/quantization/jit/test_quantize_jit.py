...
# torch.quantization
from torch.quantization import (PlaceholderObserver, QConfig, default_dynamic_qconfig, default_histogram_observer,
                                default_observer, default_per_channel_weight_observer, default_qconfig,
                                default_weight_observer, float16_dynamic_qconfig, fuse_modules, get_default_qconfig,
                                per_channel_dynamic_qconfig, quantize, quantize_dynamic, quantize_dynamic_jit,
                                quantize_jit)
# torch.quantization.quantize_jit
from torch.quantization.quantize_jit import (convert_dynamic_jit, convert_jit, fuse_conv_bn_jit, prepare_dynamic_jit,
                                             prepare_jit, script_qconfig)
from torch.testing import FileCheck
# Annotated models
from torch.testing._internal.common_quantization import (AnnotatedConvBnModel, AnnotatedConvModel,
                                                         AnnotatedConvTransposeModel, AnnotatedNestedModel,
                                                         AnnotatedSingleLayerLinearModel, AnnotatedSkipQuantModel,
                                                         ConvBnModel, ConvModel, ConvTransposeModel, NestedModel,
                                                         QuantizationTestCase, SingleLayerLinearModel, SkipQuantModel,
...
from torch.testing._internal.jit_utils import attrs_with_prefix, get_forward, get_forward_graph
