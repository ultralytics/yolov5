...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
            ...
            if det is not None and len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    if save_txt:  # Write to file
                        ...
                        image_ids.append(txt_path.split('/')[-1])
        ...
        finl_results.head()
        finl_results.to_csv('/content/drive/MyDrive/dekhi/submission.csv', index=False)
...
# finl_results['height'] = 1024
# finl_results.head()
# finl_results.to_csv('/content/drive/My Drive/Projetcs/Dhaka ai/YOLOv5/yolov5/inference/submission.csv', index=False)