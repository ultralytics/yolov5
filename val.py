...
from utils.general import coco80_to_coco91_class, check_dataset, check_yaml, check_img_size, check_requirements, \
    check_suffix, box_iou, non_max_suppression, scale_coords, xyxy2xywh, xywh2xyxy, set_logging, increment_path, \
    colorstr
...
def parse_opt():
    ...
    opt.data = check_yaml(opt.data)  # check file
    return opt
