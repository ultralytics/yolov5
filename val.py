...
def parse_opt(known= False):
    ...
    parser.add_argument('--project', default= 'yolov5_runs/val', help='save to project/name')
...
def main(opt):
    check_requirements(requirements=LOCAL_ROOT / 'requirements.txt', exclude=('tensorboard', 'thop'))
