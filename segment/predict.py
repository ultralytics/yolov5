            ...
            for i, det in enumerate(pred):  # per image
                ...
                if save_img:
                    if dataset.mode == 'image':
                        ...
                        cv2.putText(im0, f'Total piglets detected: {counter}', text_position, font, font_scale,
                                    font_color, font_thickness)
                        cv2.putText(im0, f'Max objects detected piglets all frames: {max_counter}', (10, 100), font,
                                    font_scale, font_color, font_thickness)
                        cv2.putText(im0, f'Average objects detected piglets all frames: {math.ceil(avg_count)}',
                                    (10, 200), font, font_scale, font_color, font_thickness)
                        cv2.putText(im0, f'Min objects detected piglets all frames: {min_counter}', (10, 300), font,
                                    font_scale, font_color, font_thickness)
