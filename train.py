...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    # Model parameters
    hyp['box'] *= 3. / nl  # scale hyp['box'] to output layers
    hyp['cls'] *= nc / 80. * 3. / nl  # scale hyp['cls'] to class count
    hyp['obj'] *= imgsz ** 2 / 640. ** 2  # scale hyp['obj'] to image size and output layers
