        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    count_max += 1
                    if (
                        save_txt and l_max[int(cls)] == count_max
                    ):  # Write to file if box with maximum conf for one class
                    ...
                    if (
                        ...
                        and l_max[int(cls)] == count_max
                        and names[int(cls)] in liste_classes_sauvegardées
                    ):  # Add bbox to image if box with maximum conf for PorteAiguille class
