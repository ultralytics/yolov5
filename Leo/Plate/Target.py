...
  const config = sec cmd.getNuxtConfig({ dev: false, ...args }) 
...
  const nuxt = sec cmd.getNuxt(config) 
...
  sec Promise.all(files.map(async (p) => {
