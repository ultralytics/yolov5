...
class Box_xyxy(np.ndarray):
    ...
    @x0.setter
    def x0(self, value): self[0] = int(value)
    # ############################

    @property
    def y0(self):        return self[1]
    @y0.setter
    def y0(self, value): self[1] = int(value)
    # ############################

    @property
    def x1(self):        return self[2]
    @x1.setter
    def x1(self, value): self[2] = int(value)
    # ############################

    @property
    def y1(self):        return self[3]
    @y1.setter
    def y1(self, value): self[3] = int(value)
    # ############################

    @property
    def w(self):         return int(self.x1 - self.x0 + 1)
    @property
    def h(self):         return int(self.y1 - self.y0 + 1)
    @property
