...
class MetaAconC(nn.Module):
    ...
    (p1*x-p2*x) * sigmoid(beta*(p1*x-p2*x)) + p2*x, where beta is generated by a lightweight channel-wise network
    (fc1->fc2) rather than a directly learned parameter. See "Activate or Not: Learning Customized Activation"
