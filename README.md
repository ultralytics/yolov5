...
| Model                                                                                              | size<br><sup>(pixels) | accuracy<br><sup>top1 | accuracy<br><sup>top5 | Training<br><sup>90 epochs<br>4xA100 (hours) | Speed<br><sup>ONNX-CPU<br>(ms) | Speed<br><sup>TensorRT-V100<br>(ms) | params<br><sup>(M) | FLOPs<br><sup>@224 (B) |
|----------------------------------------------------------------------------------------------------|-----------------------|-----------------------|-----------------------|----------------------------------------------|--------------------------------|-------------------------------------|--------------------|------------------------|
...
| [EfficientNet_b3](https://github.com/ultralytics/yolov5/releases/download/v6.2/efficientnet_b3.pt) | 224                   | 75.1                  | 92.4                  | 13:03                                        | 31.8                           | 11.2                                | 5.3                | 0.8                    |
