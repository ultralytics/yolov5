...
class Detect(nn.Module):
    ...
    def __init__(self, nc=80, anchors=(), ch=(), inplace=True):  # detection layer
        ...
        self.grid = nn.ParameterList(nn.Parameter() for _ in range(self.nl))  # init grid
        self.anchor_grid = nn.ParameterList(nn.Parameter() for _ in range(self.nl))  # init anchor grid
