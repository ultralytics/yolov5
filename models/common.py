...
def autopad(k, p=None):
    """Autopad.
        ...
        https://github.com/AlexeyAB/darknet/issues/4978

    Args:
        k (int): kernel
        p (int, optional): padding. Pad to 'same'. Defaults to None.

    Returns:
        int | list | Any: [description]
    """
    if p is None:
...
class Conv(nn.Module):
    ...
    def __init__(self, c1, c2, k=1, s=1, p=None, g=1, act=True):
        ...
        Args:
            ...
            k (int, optional): kernel. Defaults to 1.
            s (int, optional): stride. Defaults to 1.
            p ([type], optional): padding. Defaults to None.
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, c1, c2, shortcut=True, g=1, e=0.5):
        ...
        Args:
            c1 (torch.Tensor): ch_in
            c2 (torch.Tensor): ch_out
            shortcut (bool, optional): shortcut. Defaults to True.
            g (int, optional): groups. Defaults to 1.
            e (float, optional): expansion. Defaults to 0.5.
        """
...
class SPP(nn.Module):
    ...
    def __init__(self, c1, c2, k=(5, 9, 13)):
        ...
        Args:
            c1 (torch.Tensor): ch_in
            c2 (torch.Tensor): ch_out
            k (tuple, optional): kernel. Defaults to (5, 9, 13).
        """
...
class Concat(nn.Module):
    ...
    def __init__(self, dimension=1):
        ...
        Args:
            dimension (int, optional): Dimension. Defaults to 1.
        """
...
class NMS(nn.Module):
    ...
    def forward(self, x):
        ...
        Returns:
            Any: Non Max Suppression (NMS) detection results.
        """
...
class Detections:
    ...
    def display(self, pprint=False, show=False, save=False):
        ...
        Args:
            pprint (bool, optional): Pretty Print results. Defaults to False.
            show (bool, optional): Show results. Defaults to False.
    ...
    def tolist(self):
        ...
        Returns:
            list[Detections]: List of detection objects.
        """
...
class Classify(nn.Module):
    ...
    Example: x(b,c1,20,20) to x(b,c2)
