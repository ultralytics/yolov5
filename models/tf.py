...
class TFFocus(keras.layers.Layer):
    ...
    def call(self, inputs):
        """Performs pixel shuffling and convolution on input tensor, downsampling by 2 and expanding channels by 4. Example x(b,w,h,c) -> y(b,w/2,h/2,4c)."""
...
class TFBottleneck(keras.layers.Layer):
    ...
    def __init__(self, c1, c2, shortcut=True, g=1, e=0.5, w=None):
        """Initializes a standard bottleneck layer for TensorFlow models, expanding and contracting channels with optional shortcut. Arguments are ch_in, ch_out, shortcut, groups, expansion."""
        super().__init__()
...
class TFDetect(keras.layers.Layer):
    ...
    def __init__(self, nc=80, anchors=(), ch=(), imgsz=(640, 640), w=None):
        """Initializes YOLOv5 detection layer for TensorFlow with configurable classes, anchors, channels, and image size."""
        super().__init__()
...
class TFUpsample(keras.layers.Layer):
    ...
    def __init__(self, size, scale_factor, mode, w=None):
        """Initializes a TensorFlow upsampling layer with specified size, scale_factor, and mode, ensuring scale_factor is even. Warning: all arguments needed including 'w'"""
        super().__init__()
...
class AgnosticNMS(keras.layers.Layer):
    ...
    def _nms(x, topk_all=100, iou_thres=0.45, conf_thres=0.25):
        """Performs agnostic non-maximum suppression (NMS) on detected objects, filtering based on IoU and confidence thresholds."""
