...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            num_of_img = len(imgs)
            # print(torch.max(imgs[1]))
            for l in range(num_of_img):
                maximum_pix = torch.max(imgs[l])
                imgs[l] = imgs[l] / maximum_pix  # uint8 to float32, 0-255 to 0.0-1.0
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='yaml/80_real_80_random_synth/80_real_80_random_synth_fold1.yaml', help='data.yaml path')
