...
def parseopt():
    ...
    parser.add_argument('--class-names', nargs='*', help='filter by class: --classes dog, or --classes dog cat')

    parser.add_argument('--keep-only-topk', type=float, default=1, help="percentage of heatmap pixels to keep")
    parser.add_argument('--backprop-array', nargs='*',default='class', help="backprop array items" )
