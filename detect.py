...
<<<<<<< HEAD
    parser.add_argument('--weights', nargs='+', type=str, default=r'D:\lzy\yolov5\yolov5\runs\train\exp5\weights\best.pt', help='model path(s)')
...
>>>>>>> f4d8a84c3855fcad94bdb1104c48d3804adc7b10
